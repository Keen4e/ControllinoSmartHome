...
const unsigned long interval = 2 * 60 * 1000;              // 2 Minuten in Millisekunden
const unsigned long reconnectInterval = 10 * 60 * 1000;    // 10 Minuten
const unsigned long availabilityInterval = 1 * 60 * 1000;  // 5 Minuten
